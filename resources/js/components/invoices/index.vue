...
const getInvoices = async () => {
    let respuesta = await axios.get("/api/get_all_invoices");
    invoices.value = respuesta.data.invoices;
};

const search = async () => {

    let respuesta = await axios.get("/api/search_invoices",{
        params: {
            s: searchInvoice.value
        },
